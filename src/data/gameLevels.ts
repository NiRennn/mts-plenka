...
export const gameLevels: GameLevel[] = [
  {
    ...
    description:
      "Ты оказался на летней тусовке. Осмотрись внимательно: где-то здесь спрятана катушка плёнки.",
    variants: [
      {
        id: 1,
        image: tusovka1,
  ...
  },
  {
    ...
    description:
      "Ты зашёл в модную кофейню за своим фильтр-кофе. Посмотри внимательно по сторонам, где-то тут спрятана катушка плёнки...",
    variants: [
      {
        id: 1,
        image: cafe1,
  ...
  },
  {
    ...
    menuTitle: "ПИКНИК",
    description:
      "На веранде много деталей и бликов. Найди спрятанную катушку плёнки до окончания времени.",
    variants: [
      {
        id: 1,
        image: picnic1,
